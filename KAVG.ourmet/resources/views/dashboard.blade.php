<x-app-layout> <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
    <div :class="sidebarOpen ? 'block' : 'hidden'" @click="sidebarOpen = false" class="fixed inset-0 z-20
    transition-opacity bg-black opacity-50 lg:hidden"></div>

    <!-- Barra de tarefa lateral -->

    <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed inset-y-0 left-0
    z-30 w-64 overflow-y-auto transition duration-300 transform bg-marrom-claro lg:translate-x-0 lg:static lg:inset-0">
    ...
    <a class="flex items-center px-6 py-2 mt-4 text-gray-100 bg-white bg-opacity-25" href="#">
        ...
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945
        13H11V3.055z"></path>
                ...
                <div class="flex flex-col mt-8">
                    <div class="py-2 -my-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                        <div
                            ...
                            <div
                                class="w-full bg-white border border-marrom-claro rounded-lg shadow dark:bg-white dark:border-gray-700">
                                <div class="sm:hidden">
                                ...
                                <ul class="hidden text-sm font-medium text-center text-gray-500 divide-x divide-gray-200 rounded-lg sm:flex dark:divide-gray-600 dark:text-gray-400"
                                    ...
                                    <li class="w-full">
                                        <button id="stats-tab" data-tabs-target="#stats" type="button" role="tab"
                                            ...
                                            class="inline-block w-full p-4 rounded-tl-lg bg-gray-50 hover:bg-gray-100 focus:outline-none dark:bg-marrom-claro dark:hover:bg-marrom-claro">Usuários</button>
                                    </li>
                                    <li class="w-full">
                                        <button id="about-tab" data-tabs-target="#about" type="button" role="tab"
                                            aria-controls="about" aria-selected="false"
                                            class="inline-block w-full p-4 bg-gray-50 hover:bg-gray-100 focus:outline-none dark:bg-marrom-claro dark:hover:bg-marrom-claro">Carrinho</button>
                                    </li>
                                    <li class="w-full">
                                        <button id="faq-tab" data-tabs-target="#faq" type="button" role="tab"
                                            aria-controls="faq" aria-selected="false"
                                            class="inline-block w-full p-4 rounded-tr-lg bg-gray-50 hover:bg-gray-100 focus:outline-none dark:bg-marrom-claro dark:hover:bg-marrom-claro">Produtos</button>
                                    </li>
                                </ul>
                                <div id="fullWidthTabContent" class="border-t border-gray-200 dark:border-gray-600">
                                    <div class="hidden p-4 bg-white rounded-lg dark:bg-gray-50 " id="stats"
                                    ...
                                    <div class="hidden p-4 bg-white rounded-lg dark:bg-white" id="about" role="tabpanel"
                                        ...
                                        <table class="min-w-full">
                                            ...
                                            <tbody class="bg-white">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                        <div class="text-sm leading-5 text-gray-900">{{
                                                            $carrinho->products }}</div>
                                                    </td>

                                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                        <div class="text-sm leading-5 text-gray-900">{{
                                                            $carrinho->quantidade }}</div>
                                                    </td>

                                                    <td
                                                        class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-sm">
                                                        R$ {{ $carrinho->valor }}</td>
                                    ...
                                    <div class="hidden p-4 bg-white rounded-lg dark:bg-white" id="faq" role="tabpanel"
